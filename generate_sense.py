...
if __name__ == "__main__":
    ...
    for dataset in eval_dataset:
        file_path.append('./WSD_Evaluation_Framework/WSD_Evaluation_Framework/Evaluation_Datasets/' + dataset + '/' + dataset)
    for dataset in train_dataset:
        file_path.append('./WSD_Training_Corpora/WSD_Training_Corpora/' + dataset + '/' + dataset.lower())
    ...
    for file_name in file_path:
        ...
        lemma2sense_dict =  generate_sense(gold_key_file_name, train_file_name, train_file_final_name)

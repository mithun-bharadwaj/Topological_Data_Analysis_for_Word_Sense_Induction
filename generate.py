...
if __name__ == "__main__":
    ...
    for dataset in eval_dataset:
        file_name.append('./WSD_Evaluation_Framework/WSD_Evaluation_Framework/Evaluation_Datasets/' + dataset + '/' + dataset + '.data.xml')
    for dataset in train_dataset:
        file_name.append('./WSD_Training_Corpora/WSD_Training_Corpora/' + dataset + '/' + dataset.lower() + '.data.xml')

    for file in file_name:
        print(file)
        corpus = generate(file)
        print(corpus)